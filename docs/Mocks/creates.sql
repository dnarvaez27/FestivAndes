...
(
  ...
  CONSTRAINT FK_U_FESTIVAL FOREIGN KEY (ID_FESTIVAL) REFERENCES FESTIVALES (ID_FESTIVAL),
...
(
  ...
  CONSTRAINT FK_UR_USUARIO FOREIGN KEY (ID_USUARIO) REFERENCES USUARIOS (IDENTFICACION),
  CHECK ( EDAD > 0 )
);
...
(
  ...
  CONSTRAINT COMPANIAS_DE_TEATRO_PK PRIMARY KEY (ID, TIPO),
...
(
  ...
  CONSTRAINT FK_F_SITIO FOREIGN KEY (ID_LUGAR) REFERENCES LUGARES (ID)
...
(
  ...
  CONSTRAINT FK_S_LOCALIDAD FOREIGN KEY (ID_LOCALIDAD) REFERENCES LOCALIDADES (ID_LOCALIDAD),
...
(
  ...
  CONSTRAINT FK_B_SILLA FOREIGN KEY (NUM_SILLA, NUM_FILA, ID_LUGAR, ID_LOCALIDAD) REFERENCES SILLA (NUM_SILLA, NUM_FILA, ID_LOCALIDAD, ID_LUGAR),
...
(
  ...
  CONSTRAINT FK_O_COMPANIAS_DE_TEATRO FOREIGN KEY (ID_COMPANIA_DE_TEATRO) REFERENCES COMPANIAS_DE_TEATRO (ID),
...
(
  ...
  CONSTRAINT ESPECTACULO_REQ_TECNICOS_PK PRIMARY KEY (ID_ESPECTACULO, ID_REQUERIMIENTO_TECNICO),
  CONSTRAINT FK_ERT_REQUERIMIENTO_TECNICO FOREIGN KEY (ID_REQUERIMIENTO_TECNICO) REFERENCES REQUERIMIENTOS_TECNICOS (ID),
...
CREATE TABLE LUGAR_REQ_TECNICOS
(
  ID_LUGAR                 NUMBER NOT NULL,
  ID_REQUERIMIENTO_TECNICO NUMBER NOT NULL,
  CONSTRAINT LUGAR_REQ_TECNICOS_PK PRIMARY KEY (ID_LUGAR, ID_REQUERIMIENTO_TECNICO),
  CONSTRAINT FK_LRT_REQUERIMIENTO_TECNICO FOREIGN KEY (ID_REQUERIMIENTO_TECNICO) REFERENCES REQUERIMIENTOS_TECNICOS (ID),
...
(
  ...
  CONSTRAINT FK_CLIENTE_REGISTRADO FOREIGN KEY (ID_USUARIO) REFERENCES USUARIOS_REGISTRADOS (ID_USUARIO),
  CONSTRAINT FK_CATEGORIA FOREIGN KEY (ID_GENERO) REFERENCES GENEROS (ID)
);
...
(
  ...
  CONSTRAINT FK_CLIENTE_REGISTRADO FOREIGN KEY (ID_USUARIO) REFERENCES USUARIOS_REGISTRADOS (ID_USUARIO),
  CONSTRAINT FK_SITIO FOREIGN KEY (ID_LUGAR) REFERENCES LUGARES (ID)
);
