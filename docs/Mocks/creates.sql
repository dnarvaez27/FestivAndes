...
(
  ...
  CONSTRAINT FK_S_LUGAR FOREIGN KEY (ID_LUGAR) REFERENCES LUGARES (ID),
  CHECK ( NUM_FILA >= 0 ),
  CHECK ( NUM_SILLA >= 0 )
);
...
(
  ...
  CONSTRAINT FK_B_SILLA FOREIGN KEY (NUM_SILLA, NUM_FILA, ID_LUGAR, ID_LOCALIDAD)
                  REFERENCES SILLAS (NUM_SILLA, NUM_FILA, ID_LUGAR, ID_LOCALIDAD),
