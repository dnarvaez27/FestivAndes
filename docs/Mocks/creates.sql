...
(
  ...
  CONSTRAINT FK_UR_USUARIO FOREIGN KEY (TIPO_ID, ID_USUARIO) REFERENCES USUARIOS (TIPO_ID, IDENTFICACION),
  CHECK ( EDAD > 0 )
);
...
(
  ...
  FECHA        DATE   NOT NULL,
  ID_USUARIO   NUMBER NOT NULL,
  ID_TIPO_IDENTIFICIACION_USUARIO VARCHAR2(10) NOT NULL,
  ...
  CONSTRAINT FK_B_USUARIO FOREIGN KEY (ID_USUARIO, ID_TIPO_IDENTIFICACION) REFERENCES USUARIO (ID_USUARIO, TIPO_IDENTIFICACION)
