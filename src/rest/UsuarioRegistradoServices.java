...
public class UsuarioRegistradoServices extends Services {
	...
	@POST
	public Response createUsuarioRegistrado(UsuarioRegistrado accesibilidad, @HeaderParam("id") Long id,
	...
	@PUT
	@Path("{id}/{tipo}")
	public Response updateUsuarioRegistrado(@PathParam("id") Long id, @PathParam("tipo") String tipo,
	...
	public Response createEntryGeneroPreferido(@PathParam("idUsuario") Long idUsuario, @PathParam("tipo") String tipo,
			@PathParam("idGenero") Long idGenero) {
		PreferenciaGeneroTM tm = new PreferenciaGeneroTM(getPath());
		try {
	...
	@DELETE
	@Path("{idUsuario}/{tipo}/generos/{idGenero}")
	public Response deleteEntryGeneroPreferido(@PathParam("idUsuario") Long idUsuario, @PathParam("tipo") String tipo,
			@PathParam("idGenero") Long idGenero) {
		PreferenciaGeneroTM tm = new PreferenciaGeneroTM(getPath());
		try {
	...
	public Response getLugarPreferido(@PathParam("id_usuario") Long idUsuario, @PathParam("tipo") String tipo,
	...
	@POST
	@Path("{id_usuario}/{tipo}/lugares/{id_lugar}")
	public Response createLugarPreferido(@PathParam("id_usuario") Long idUsuario, @PathParam("tipo") String tipo,
			@PathParam("id_lugar") Long idLugar) {
		PreferenciaLugarTM tm = new PreferenciaLugarTM(getPath());
		try {
	...
	@DELETE
	@Path("{id_usuario}/{tipo}/lugares/{id_lugar}")
	public Response deleteLugarPreferido(@PathParam("id_usuario") Long idUsuario, @PathParam("tipo") String tipo,
			@PathParam("id_lugar") Long idLugar) {
		PreferenciaLugarTM tm = new PreferenciaLugarTM(getPath());
		try {
	...
	public Response asistenciaUsuario(@PathParam("id_usuario") Long id, @PathParam("tipo") String tipo,
			@HeaderParam("password") String password) {
		UsuarioRegistradoCM tm = new UsuarioRegistradoCM(getPath());
		RFC7 rfc7;
		try {
	...
	@GET
	@Path("/buenos")
	public Response clientesBuenos(@HeaderParam("id_usuario") Long id, @HeaderParam("tipo") String tipo,
			@HeaderParam("password") String password, @QueryParam("cantidad") Integer cantidad) {
		UsuarioRegistradoCM tm = new UsuarioRegistradoCM(getPath());
		List<RFC12> rfc12;
		try {
