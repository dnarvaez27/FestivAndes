...
public class DAOUsuario extends DAO {
    ...
    public List<RFC7> asistenciaUsuariosRegistrados() throws SQLException {
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT B.FECHA, B.ID_LUGAR, E.NOMBRE AS NOMBRE_ESPECTACULO, COUNT(*) AS TOTAL, F.SE_REALIZA, F.ID_ESPECTACULO, E.DURACION, U.IDENTIFICACION, U.TIPO_IDENTIFICACION ");
        sql.append("FROM ");
        ...
        sql.append("GROUP BY F.FECHA, F.LUGAR, U.IDENTIFICACION, U.TIPO_IDENTIFICACION");
        ...
        while (rs.next()) {
            ...
            req.setIdUsuario(rs.getLong("U.IDENTIFICACION"));
            req.setTipo(rs.getString("U.TIPO_IDENTIFICACION"));
        }
        return resp;
    }
}
