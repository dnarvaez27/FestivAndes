...
public class DAOUsuarioRegistrado extends DAO
{
	...
	public List<UsuarioRegistrado> getUsuarioRegistrados( ) throws SQLException
	{
		...
		while( rs.next( ) )
		{
			list.add( resultToUsuarioRegistrado( rs ) );
		}
		rs.close( );
		s.close( );
		return list;
	...
	public UsuarioRegistrado getUsuarioRegistrado( Long id, String tipoId ) throws SQLException
	{
		...
		if( rs.next( ) )
		{
			object = resultToUsuarioRegistrado( rs );
		}
		rs.close( );
		s.close( );
		return object;
	...
	public static UsuarioRegistrado resultToUsuarioRegistrado( ResultSet rs ) throws SQLException
	{
	...
	public RFC7 asistenciaCliente( Long id, String tipo ) throws SQLException
	{
		...
		sql.append( "GROUP BY F.FECHA, F.ID_LUGAR, B.FECHA, B.ID_LUGAR, E.NOMBRE, F.SE_REALIZA, F.ID_ESPECTACULO, E.DURACION " );
