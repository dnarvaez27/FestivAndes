...
public class DAOUsuarioRegistrado extends DAO {
    ...
    public RFC7 asistenciaCliente(Long id, String tipo) throws SQLException {
        StringBuilder sql = new StringBuilder();
        sql.append("SELECT B.FECHA, B.ID_LUGAR, E.NOMBRE AS NOMBRE_ESPECTACULO, COUNT(*) AS TOTAL, F.SE_REALIZA, F.ID_ESPECTACULO, E.DURACION ");
        sql.append("FROM ");
        ...
        sql.append("GROUP BY F.FECHA, F.LUGAR");
